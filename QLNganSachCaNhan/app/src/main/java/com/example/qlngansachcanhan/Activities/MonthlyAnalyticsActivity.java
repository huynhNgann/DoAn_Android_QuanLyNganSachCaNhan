...
public class MonthlyAnalyticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Biểu đồ tháng");
...
//imageviews
    ...
    private void getTotalWeekTransportExpense() {
        ...
        String itemNmonth = "Xe cộ"+months.getMonths();
    ...
    private void getTotalMonthsFoodExpense(){
        ...
        String itemNmonth = "Ăn uống"+months.getMonths();
    ...
    private void getTotalMonthsHouseExpense(){
        ...
        String itemNmonth = "Chi phí nhà"+months.getMonths();
    ...
    private void getTotalMonthEntertainmentExpenses(){
        ...
        String itemNmonth = "Giải trí"+months.getMonths();
    ...
    private void getTotalWeekEducationExpenses(){
        ...
        String itemNmonth = "Giáo dục"+months.getMonths();
    ...
    private void getTotalWeekCharityExpenses(){
        ...
        String itemNmonth = "Từ thiện"+months.getMonths();
    ...
    private void getTotalWeekApparelExpenses(){
        ...
        String itemNmonth = "Quàn áo và du lịch"+months.getMonths();
    ...
    private void getTotalWeekHealthExpenses(){
        ...
        String itemNmonth = "Sức khỏe"+months.getMonths();
    ...
    private void getTotalWeekPersonalExpenses(){
        ...
        String itemNmonth = "Chi tiêu cá nhân"+months.getMonths();
